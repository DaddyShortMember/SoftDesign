...
public class CampaignDTO {
	...
	public CampaignDTO(String name, String description, String start, String end, float target, String country) {
		super();
		this.name = name;
	...
	public CampaignDTO(Long id, String name, String description, String start, String end, float target, String country) {
		super();
		this.id = id;
		this.name = name;
		this.description = description;
